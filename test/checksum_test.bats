...
@test "verify_with_checksum_string_in_file" {
  GR_CHECKSUM__ALGO=sha256 \
    GR_CHECKSUM__FILE_PATH="${_TEST_DIR}/resources/checksum/sample.txt" \
    GR_CHECKSUM__CHECKSUM_PATH="${_TEST_DIR}/resources/checksum/sample.txt.sha256" \
    verify_with_checksum_string_in_file
  run ! GR_CHECKSUM__ALGO=sha256 \
    GR_CHECKSUM__FILE_PATH="${_TEST_DIR}/resources/checksum/sample.txt" \
    GR_CHECKSUM__CHECKSUM_PATH="${_TEST_DIR}/resources/checksum/sample.txt.sha256.incorrect" \
    verify_with_checksum_string_in_file
}
